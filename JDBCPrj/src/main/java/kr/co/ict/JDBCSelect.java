package kr.co.ict;
//SQL관련 요소는 java.sql.*을 임포트하면 대부분이 다 로드됩니다.
import java.sql.*;
...
public class JDBCSelect {
	...
	public static void main(String[] args) {
		...
		try {
			// Mysql을 연동할 것임을 알리기 위해 forName내부에 mysql연동구문을 적습니다.
			// SQL연동은 try~catch블럭 내부에 넣도록 강제됨.
			Class.forName("com.mysql.cj.jdbc.Driver");
			// 커넥션 객체는 연결 여부를 확인합니다.
			// 입력 요소는 접속주소,mysql계정명,mysql 비밀번호 순으로 입력합니다.
